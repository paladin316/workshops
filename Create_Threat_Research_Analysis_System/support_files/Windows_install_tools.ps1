...
cmd /C mkdir c:\stuff
cp "T:\support_files\Sysmon64.exe" c:\stuff\
...
cp T:\support_files\inputs.conf "C:\Program Files\SplunkUniversalForwarder\etc\apps\SplunkUniversalForwarder\local\inputs.conf"
